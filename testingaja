...
local function safeSetClipboard(value)
    if not setclipboard then
        WindUI:Notify({
            ...
            Content = "Clipboard function is not available in this environment.",
            Icon = "alert-triangle"
        })
        return false
    end
...
-- Tambahkan ke toggleMap
toggleMap["Buy All Tools"] = { var = "buyAllToolsOnce", value = false, toggle = nil, callback = nil }

-- State variable baru
local buyAllToolsOnce = false
...
-- List semua tool yang ingin dibeli
local toolsList = {"Invisibility Cloak", "Quantum Cloner", "Medusa's Head"}

-- Toggle di ShopTab
toggleMap["Buy All Tools"].toggle = ShopTab:Toggle({
    Title = "All Tools Stealing",
    Desc = "Buy All Stealing Tools like Invisibility Cloak, Quantum Cloner, Medusa's Head.",
    Value = false,
    Callback = function(state)
        buyAllToolsOnce = state
        toggleMap["Buy All Tools"].value = state

        if state then
            for _, tool in ipairs(toolsList) do
                buyItem(tool) -- beli satu per satu
            end

            WindUI:Notify({
                Title = "Buy All Tools",
                Content = "Purchased all tools",
                Icon = "rbxassetid://114691672281339"
            })
        end
    end
...
toggleMap["Buy All Tools"].callback = toggleMap["Buy All Tools"].toggle.Callback

-- Tambahkan ke toggleMap
toggleMap["Buy Body Swap Potion"] = { var = "buyBodySwapOnce", value = false, toggle = nil, callback = nil }

-- State variable baru
local buyBodySwapOnce = false

-- Toggle di ShopTab
toggleMap["Buy Body Swap Potion"].toggle = ShopTab:Toggle({
    Title = "Body Swap Potion",
    Desc = "Buy Body Swap Potion once when enabled.",
    Value = false,
    Callback = function(state)
        buyBodySwapOnce = state
        toggleMap["Buy Body Swap Potion"].value = state

        if state then
            buyItem("Body Swap Potion") -- beli satu kali
            WindUI:Notify({
                Title = "Body Swap Potion",
                Content = "Purchased",
                Icon = "rbxassetid://114691672281339"
...
toggleMap["Buy Body Swap Potion"].callback = toggleMap["Buy Body Swap Potion"].toggle.Callback

-- Tambahkan ke toggleMap
toggleMap["Buy Rainbowrarth Sword"] = { var = "buyRainbowrarthOnce", value = false, toggle = nil, callback = nil }

-- State variable baru
local buyRainbowrarthOnce = false

-- Toggle di ShopTab
toggleMap["Buy Rainbowrarth Sword"].toggle = ShopTab:Toggle({
    Title = "Rainbowrarth Sword",
    Desc = "Buy Rainbowrarth Sword once when enabled.",
    Value = false,
    Callback = function(state)
        buyRainbowrarthOnce = state
        toggleMap["Buy Rainbowrarth Sword"].value = state

        if state then
            buyItem("Rainbowrarth Sword") -- beli satu kali
            WindUI:Notify({
                Title = "Rainbowrarth Sword",
                Content = "Purchased",
                Icon = "rbxassetid://114691672281339"
...
toggleMap["Buy Rainbowrarth Sword"].callback = toggleMap["Buy Rainbowrarth Sword"].toggle.Callback

-- Tambahkan ke toggleMap
toggleMap["Buy All Seeing Sentry"] = { var = "buyAllSeeingSentryOnce", value = false, toggle = nil, callback = nil }

-- State variable baru
local buyAllSeeingSentryOnce = false

-- Toggle di ShopTab
toggleMap["Buy All Seeing Sentry"].toggle = ShopTab:Toggle({
    Title = "All Seeing Sentry",
    Desc = "Buy All Seeing Sentry once when enabled.",
    Value = false,
    Callback = function(state)
        buyAllSeeingSentryOnce = state
        toggleMap["Buy All Seeing Sentry"].value = state

        if state then
            buyItem("All Seeing Sentry") -- beli satu kali
            WindUI:Notify({
                Title = "All Seeing Sentry",
                Content = "Purchased",
                Icon = "rbxassetid://114691672281339"
...
toggleMap["Buy All Seeing Sentry"].callback = toggleMap["Buy All Seeing Sentry"].toggle.Callback

-- Tambahkan ke toggleMap
toggleMap["Buy Invisibility Cloak"] = { var = "buyInvisibilityCloakOnce", value = false, toggle = nil, callback = nil }

-- State variable baru
local buyInvisibilityCloakOnce = false

-- Toggle di ShopTab
toggleMap["Buy Invisibility Cloak"].toggle = ShopTab:Toggle({
    Title = "Invisibility Cloak",
    Desc = "Buy Invisibility Cloak once when enabled.",
    Value = false,
    Callback = function(state)
        buyInvisibilityCloakOnce = state
        toggleMap["Buy Invisibility Cloak"].value = state

        if state then
            buyItem("Invisibility Cloak") -- beli satu kali
            WindUI:Notify({
                Title = "Invisibility Cloak",
                Content = "Purchased",
                Icon = "rbxassetid://114691672281339"
...
toggleMap["Buy Invisibility Cloak"].callback = toggleMap["Buy Invisibility Cloak"].toggle.Callback

-- Tambahkan ke toggleMap
toggleMap["Buy Quantum Cloner"] = { var = "buyQuantumClonerOnce", value = false, toggle = nil, callback = nil }

-- State variable baru
local buyQuantumClonerOnce = false

-- Toggle di ShopTab
toggleMap["Buy Quantum Cloner"].toggle = ShopTab:Toggle({
    Title = "Quantum Cloner",
    Desc = "Buy Quantum Cloner once when enabled.",
    Value = false,
    Callback = function(state)
        buyQuantumClonerOnce = state
        toggleMap["Buy Quantum Cloner"].value = state

        if state then
            buyItem("Quantum Cloner") -- beli satu kali
            WindUI:Notify({
                Title = "Quantum Cloner",
                Content = "Purchased",
                Icon = "rbxassetid://114691672281339"
...
toggleMap["Buy Quantum Cloner"].callback = toggleMap["Buy Quantum Cloner"].toggle.Callback

-- Tambahkan ke toggleMap
toggleMap["Buy Medusa's Head"] = { var = "buyMedusasHeadOnce", value = false, toggle = nil, callback = nil }

-- State variable baru
local buyMedusasHeadOnce = false

-- Toggle di ShopTab
toggleMap["Buy Medusa's Head"].toggle = ShopTab:Toggle({
    Title = "Medusa's Head",
    Desc = "Buy Medusa's Head once when enabled.",
    Value = false,
    Callback = function(state)
        buyMedusasHeadOnce = state
        toggleMap["Buy Medusa's Head"].value = state

        if state then
            buyItem("Medusa's Head") -- beli satu kali
            WindUI:Notify({
                Title = "Medusa's Head",
                Content = "Purchased",
                Icon = "rbxassetid://114691672281339"
...
toggleMap["Buy Medusa's Head"].callback = toggleMap["Buy Medusa's Head"].toggle.Callback

-- Tambahkan ke toggleMap
toggleMap["Buy Trap"] = { var = "buyTrapOnce", value = false, toggle = nil, callback = nil }

-- State variable baru
local buyTrapOnce = false

-- Toggle di ShopTab
toggleMap["Buy Trap"].toggle = ShopTab:Toggle({
    Title = "Buy Trap",
    Desc = "Buy Trap once when enabled.",
    Value = false,
    Callback = function(state)
        buyTrapOnce = state
        toggleMap["Buy Trap"].value = state

        if state then
            buyItem("Trap") -- beli satu kali
            WindUI:Notify({
                Title = "Buy Trap",
                Content = "Purchased",
                Icon = "rbxassetid://114691672281339"
...
toggleMap["Buy Trap"].callback = toggleMap["Buy Trap"].toggle.Callback
...
HopeServerTab:Button({
    ...
    Callback = function()
        ...
        if not jobId or jobId == "" then
            WindUI:Notify({
                Title = "Copy Error",
                Content = "No valid Job ID available to copy",
                Icon = "alert-triangle"
            })
            return
        end
        if safeSetClipboard(jobId) then
            WindUI:Notify({
                Title = "Copied",
